...
1. Install and run [EasyDiffusion](https://easydiffusion.github.io/)
...
4. Rename `.env.example` to `.env` and edit the `.env` file
...
6. You can interact with the bot by @mentioning it with your message
