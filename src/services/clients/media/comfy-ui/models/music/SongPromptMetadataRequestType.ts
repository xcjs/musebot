        ...
        properties: {
            tags: {
                ...
                description: 'Descriptive tags for the song caption. Each tag is a short term or phrase. '
                    + 'Cover these dimensions where relevant: genre (pop, rock, jazz, electronic, lo-fi, synthwave), '
                    + 'emotion (melancholic, uplifting, energetic, dreamy, dark, nostalgic), '
                    + 'instruments (acoustic guitar, piano, synth pads, 808 drums, strings, brass), '
                    + 'timbre texture (warm, bright, crisp, airy, punchy, lush, raw), '
                    + 'vocal characteristics (female vocal, male vocal, breathy, powerful, falsetto, raspy, choir), '
                    + 'production style (lo-fi, studio-polished, bedroom pop, live recording), '
                    + 'and era reference (80s synth-pop, 90s grunge, modern trap). '
