...
import { MessageService } from './services/clients/discord/services/MessageService.js';
    ...
    case BotFunction.Images:
        switch(environmentSettings.stableDiffusionApiType) {
            case StableDiffusionApiType.Automatic1111:
                client = new DiscordAutomatic1111Client(environmentSettings, featureService, messageService, taskQueue, typingService);
                break;
                case StableDiffusionApiType.EasyDiffusion:
                client = new DiscordEasyDiffusionClient(environmentSettings, featureService, messageService, taskQueue, typingService);
                break;
        }
        break;
